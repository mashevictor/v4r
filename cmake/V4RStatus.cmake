...
function(v4r_dependency_status _NAME)
  ...
  if(HAVE_${_NAME})
    if(BUILD_${_NAME})
      ...
      if(DEFINED ${_NAME}_LIBRARIES AND NOT ${_NAME}_LIBRARIES STREQUAL "" AND NOT ${_NAME}_LIBRARIES MATCHES ";")
        if(TARGET ${${_NAME}_LIBRARIES})
          get_target_property(_location ${${_NAME}_LIBRARIES} LOCATION)
          set(_at " (${_location})")
        else()
          set(_at " (${${_NAME}_LIBRARIES})")
        endif()
      elseif(DEFINED ${_NAME}_INCLUDE_DIRS AND NOT ${_NAME}_INCLUDE_DIRS STREQUAL "" AND NOT ${_NAME}_INCLUDE_DIRS MATCHES ";")
        set(_at " (${${_NAME}_INCLUDE_DIRS})")
      elseif(DEFINED ${_NAME}_ROOT AND NOT ${_NAME}_ROOT STREQUAL "")
        set(_at " (${${_NAME}_ROOT})")
      endif()
