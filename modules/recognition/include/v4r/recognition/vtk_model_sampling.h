...
inline void randomPointTriangle(double a1, double a2, double a3, double b1, double b2, double b3, double c1, double c2,
...
inline void uniform_sampling(vtkSmartPointer<vtkPolyData> polydata, size_t n_samples,
...
template <typename PointT>
inline void uniform_sampling(const std::string& file, size_t n_samples, typename pcl::PointCloud<PointT>& cloud_out,
                             float scale = 1.f) {
...
inline void getVerticesAsPointCloud(vtkSmartPointer<vtkPolyData> polydata, pcl::PointCloud<pcl::PointXYZ>& cloud_out) {
