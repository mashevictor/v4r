 ...
 */
inline V4R_EXPORTS boost::dynamic_bitset<> binary_operation(const boost::dynamic_bitset<> &mask1,
                                                            const boost::dynamic_bitset<> &mask2, int operation) {
...
inline boost::dynamic_bitset<> createMaskFromVecIndices(const typename std::vector<std::vector<IdxT>> &v_indices,
                                                        size_t image_size) {
