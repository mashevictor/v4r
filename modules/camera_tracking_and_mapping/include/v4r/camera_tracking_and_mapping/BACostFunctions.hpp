...
struct ReprojectionErrorGlobalPoseCamViewData {
  ReprojectionErrorGlobalPoseCamViewData(const double &_observed_x, const double &_observed_y, const double &_error_weight=1.)
...
struct RadialDistortionReprojectionErrorGlobalPoseCamViewData {
  RadialDistortionReprojectionErrorGlobalPoseCamViewData(const double &_observed_x, const double &_observed_y, const double &_error_weight=1.)
      : observed_x(_observed_x), observed_y(_observed_y), error_weight(_error_weight) {}
