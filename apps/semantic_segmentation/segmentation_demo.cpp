...
static bool parseArgs(int argc, char **argv) {
  ...
  sv.add_options()("help,h", "")("voxel-resolution,v", po::value<float>(&voxelResolution)->default_value(0.01),
  ...
  hidden.add_options()("pointcloudfile,i", po::value<std::string>(&inputfile), "");
...
static void getInlierIndices(pcl::PointCloud<pcl::PointXYZRGB>::ConstPtr cloud, int meanK, double stddevMulThresh,
...
static void applyBilateralFilter(pcl::PointCloud<pcl::PointXYZRGB>::ConstPtr inputcloud, pcl::IndicesConstPtr indices,
                                 double sigmaS, double sigmaR, pcl::PointCloud<pcl::PointXYZRGB>::Ptr outputcloud) {
...
static void removeOutliers(pcl::PointCloud<pcl::PointXYZRGB>::ConstPtr inputcloud, pcl::IndicesConstPtr indices,
...
static void segmentPointcloud(pcl::PointCloud<pcl::PointXYZRGB>::Ptr &cloud,
...
int main(int argc, char **argv) {
  ...
  pcl::Grabber *interface = nullptr;

  segmenter = new v4r::SupervoxelSegmentation<pcl::PointXYZRGB>(voxelResolution, seedResolution, colorImportance,
                                                                normalImportance, spatialImportance, mergingThreshold,
                                                                colorW, normalW, curvatureW, ptplW, cie94, singleframe);
