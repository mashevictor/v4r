...
void ObjectRecognitionVisualizer<PointT>::flipOpacity(const std::string &cloud_name, double max_opacity) const {
  double opacity;
...
void ObjectRecognitionVisualizer<PointT>::visualize() const {
  ...
  verified_hyp_ss << "verified hypotheses (" << verified_object_hypotheses_.size() << ")";
